...
class InterferometerServer:
    def __init__(self, root):
        ...
        self.new_data_label = tk.Label(self.graph_frame, text="Last Data Point: N/A", font=("OCR A Extended", 12), bg="black", fg="white", justify="left", anchor="w", width=50)
    ...
    def update_graph(self):
        if self.update_data():    
            # Update label
            self.new_data_label.config(text=f"Reading: {self.data_points[-1]}")
